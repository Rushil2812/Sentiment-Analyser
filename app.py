...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        with col1:
            st.markdown("<h3 style='text-align: center; color: gray;'>Monthly Activity map(Positive)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col2:
            st.markdown("<h3 style='text-align: center; color: grey;'>Monthly Activity map(Neutral)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col3:
            st.markdown("<h3 style='text-align: center; color: grey;'>Monthly Activity map(Negative)</h3>",unsafe_allow_html=True)
        ...
        col1, col2, col3 = st.columns(3)
        with col1:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Activity map(Positive)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col2:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Activity map(Neutral)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col3:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Activity map(Negative)</h3>",unsafe_allow_html=True)
        ...
        col1, col2, col3 = st.columns(3)
        with col1:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Timeline(Positive)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col2:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Timeline(Neutral)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col3:
            st.markdown("<h3 style='text-align: center; color: grey;'>Daily Timeline(Negative)</h3>",unsafe_allow_html=True)
        ...
        col1, col2, col3 = st.columns(3)
        with col1:
            st.markdown("<h3 style='text-align: center; color: grey;'>Monthly Timeline(Positive)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col2:
            st.markdown("<h3 style='text-align: center; color: grey;'>Monthly Timeline(Neutral)</h3>",unsafe_allow_html=True)
            ...
            st.pyplot(fig)
        with col3:
            st.markdown("<h3 style='text-align: center; color: grey;'>Monthly Timeline(Negative)</h3>",unsafe_allow_html=True)
        ...
        if selected_user == 'Overall':
            col1,col2,col3 = st.columns(3)
            with col1:
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Positive Contribution</h3>",unsafe_allow_html=True)
                x = helper.percentage(data, 1)

                # Displaying
                st.dataframe(x)
            with col2:
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Neutral Contribution</h3>",unsafe_allow_html=True)
                y = helper.percentage(data, 0)

                # Displaying
                st.dataframe(y)
            with col3:
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Negative Contribution</h3>",unsafe_allow_html=True)
        ...
        if selected_user == 'Overall':
            ...
            with col1:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Positive Users</h3>",unsafe_allow_html=True)
            ...
            with col2:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Neutral Users</h3>",unsafe_allow_html=True)
            ...
            with col3:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Most Negative Users</h3>",unsafe_allow_html=True)
        ...
        with col1:
            try:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Positive WordCloud</h3>",unsafe_allow_html=True)
        ...
        with col2:
            try:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Neutral WordCloud</h3>",unsafe_allow_html=True)
        ...
        with col3:
            try:
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Negative WordCloud</h3>",unsafe_allow_html=True)
        ...
        with col1:
            try:
                ...
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Positive Words</h3>",unsafe_allow_html=True)
                fig, ax = plt.subplots()
        ...
        with col2:
            try:
                ...
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Neutral Words</h3>",unsafe_allow_html=True)
                fig, ax = plt.subplots()
        ...
        with col3:
            try:
                ...
                # heading
                st.markdown("<h3 style='text-align: center; color: grey;'>Negative Words</h3>",unsafe_allow_html=True)
                fig, ax = plt.subplots()
